...
public class SiteUserResetPassword extends CreateSiteUser{

	public SiteUserResetPassword(WebDriver driver) {
		super(driver);
	}
					...
					int columns_count = Columns_row.size();
				   	...
				   	Iterator<WebElement> iterator = tags_row.iterator();
				   	  ...
				   	  WebElement next = iterator.next();
				   	     if(next.getAttribute("href").contains("SiteAdminResetpassword")) {
				   	         next.click();
				   	            break;
			      		              }		   	
				   	  			}
