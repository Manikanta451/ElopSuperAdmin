...
public class DeleteMenuMeal extends CreateMenuMeal{

	public DeleteMenuMeal(WebDriver driver) {
		super(driver);
	}
	
	public void delmenumeal()throws Exception{
	...
	public void tablehandle()throws Exception{
			      ...
			      List < WebElement > tags_row = Columns_row.get(3).findElements(By.tagName("a"));
			   	  ...
			   	  String dynamic = "//*[@id=\"commond_".concat(delId[1]).concat("\"]/button[2]");		   	  
