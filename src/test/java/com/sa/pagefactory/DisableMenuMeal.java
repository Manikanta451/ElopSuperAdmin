...
public class DisableMenuMeal extends CreateMenuMeal{

	public DisableMenuMeal(WebDriver driver) {
		super(driver);
	}
	
	public void disablemeal()throws Exception{
	...
	public void tablehandle()throws Exception{
				     ...
				     // String celtext = Columns_row.get(column).getText();
				      ...
				      List < WebElement > tags_row = Columns_row.get(3).findElements(By.tagName("a"));
				   	  ...
				   	  String dynamic = "//*[@id=\"commond_".concat(delId[1]).concat("\"]/button[1]");		   	  
